...
import { appStateReducer } from '../features/app-state.reducer';
...
export function provideTranslateModule(): (Provider | EnvironmentProviders)[] {
  return [
    ...
    provideTranslateHttpLoader({
      prefix: `${environment.linkurl}public/i18n/`,
      suffix: '.json'
    })
  ];
}
export function provideNgRx(): EnvironmentProviders[] {
  return [
    // 📌 NgRx Store Configuration with Reducers
    provideStore({
